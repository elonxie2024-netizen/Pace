...
public class ScreenTime : Form {
    ...
    public ScreenTime(string dataFolder) {
        ...
        string art=Path.Combine(AppDomain.CurrentDomain.BaseDirectory,"assets","pace-garden-compact.png"); if(File.Exists(art)) { BackgroundImage=Image.FromFile(art); BackgroundImageLayout=ImageLayout.Zoom; }
